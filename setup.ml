...
(* OASIS_START *)
(* DO NOT EDIT (digest: 468f0c21f99df63ca89b8496dbca8559) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://github.com/chambart/ocaml-urg";
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "angles.ml"});
               Executable
                 ({
                     cs_name = "test_lwt";
                     cs_data = PropList.Data.create ();
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/chambart/ocaml-urg";
                      src_repo_browser =
                        Some "https://github.com/chambart/ocaml-urg";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "}\250\158\171\244n{\208n\017\229\016\198\155K\135";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
